...
# ------------------------------------------------------------
# RACINE DU PROJET — Référence absolue unique
# ------------------------------------------------------------
...
OUTPUT_DIR    = ROOT_DIR / "suivi"      / "output"
...
PRIX_XLSX         = SUIVI_DIR / "prix.xlsx"
SUIVI_POIDS_XLSX  = OUTPUT_DIR / "suivi_poids.xlsx"

# ------------------------------------------------------------
# FICHIERS EXCEL ATHLÈTE
# ------------------------------------------------------------
...
# MAGASIN
# ------------------------------------------------------------
MAGASIN_DEFAUT   = "leclerc"   # "leclerc" ou "auchan"
CACHE_PRIX_JOURS = 7
...
# ------------------------------------------------------------
# OPTIMISATION NUTRITIONNELLE — Recommandations ISSN 2023
# ------------------------------------------------------------
...
def get_parametres_objectif(objectif: str) -> dict:
    """
    Retourne les paramètres correspondant à l'objectif.
    Recherche partielle insensible à la casse.
    Retourne 'recomposition' par défaut si non reconnu.
    """
...
# ------------------------------------------------------------
for _dir in [DATA_DIR, SUIVI_DIR, OUTPUT_DIR, OPTIM_DIR, LOGS_DIR]:
